...
Page {
    ...
    /**
     * Shows the subtitle search and focuses its text field.
     */
    function showSubtitleSearch() {
        footerPane.visible = true;
    ...
    Action {
        ...
        onTriggered: root.showSubtitleSearch()
    }
    ...
    header: ToolBar {
        ...
        contentItem: RowLayout {
            ...
            ToolButton {
                ...
                text: qsTr("Search subtitles")
                display: AbstractButton.IconOnly
                focusPolicy: Qt.NoFocus
                icon.name: MementoSettings.interfaceSystemIcons ?
                               "edit-find" : null
                icon.source: Utils.toImageProvider(
                    "search", MementoPalette.text);
    ...
    StackLayout {
        ...
        SubtitleList {
            ...
            onStartFromSubtitleRequested: (start) => {
                root.player.controller.setSubtitleDelay(
                    root.player.state.timePosition - start);
            }
        }
        ...
        SubtitleList {
            ...
            onSeekRequested: (pos) => root.player.controller.seek(pos)
            onStartFromSubtitleRequested: (start) => {
                root.player.controller.setSecondarySubtitleDelay(
                    root.player.state.timePosition - start);
            }
        }
    }
    ...
    footer: Pane {
        ...
        Connections {
            ...
            function onSearchRemoveRegexChanged() {
                searchSettingsConnections.refreshSearch();
            }

            function onSubtitleListIgnoreWhitespaceChanged() {
                searchSettingsConnections.refreshSearch();
            }
        }
