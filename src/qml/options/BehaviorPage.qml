            ...
            SettingsBox {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Label {
                            Layout.fillWidth: true
                            text: qsTr("Automatically copy subtitles to clipboard")
                        }
                        Switch {
                            checked: MementoSettings.behaviorSubtitleAutoCopy
                            onClicked: MementoSettings.behaviorSubtitleAutoCopy = checked
                        }
                    }
                    Label {
                        Layout.fillWidth: true
                        wrapMode: Text.Wrap
                        text: qsTr("Copy each new primary subtitle. Keep the last line during subtitle gaps.")
                    }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(MementoSettings.behaviorFileOpenDirectory)
