    ...
    ScrollView {
        ...
        ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(AnkiConfig.profile.duplicatePolicy)
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(AnkiConfig.profile.screenshotType)
            ...
            AnkiNoteBox {
                ...
                decks: root.decks
                currentDeckIndex: decks.indexOf(AnkiConfig.profile.termDeck)
                onDeckActivated: function(index) {
                    AnkiConfig.profile.termDeck = decks[index];
                }

                models: root.models
                currentModelIndex: models.indexOf(AnkiConfig.profile.termModel)
            ...
            AnkiNoteBox {
                ...
                decks: root.decks
                currentDeckIndex: decks.indexOf(AnkiConfig.profile.kanjiDeck)
                onDeckActivated: function(index) {
                    AnkiConfig.profile.kanjiDeck = decks[index];
                }

                models: root.models
                currentModelIndex: models.indexOf(AnkiConfig.profile.kanjiModel)
                onModelActivated: function(index) {
                    let model = models[index];
