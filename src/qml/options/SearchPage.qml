                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(MementoSettings.searchMethod)
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(MementoSettings.searchModifier)
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            ...
                            textRole: "text"
                            valueRole: "value"
                            currentIndex: indexOfValue(MementoSettings.searchGlossaryStyle)
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Label {
                            Layout.fillWidth: true
                            Layout.alignment: Qt.AlignLeft
                            text: qsTr("Render primary and secondary subtitles with Memento")
                        }
                        Switch {
                            Layout.alignment: Qt.AlignRight
