...
{
    Q_OBJECT
    Q_PROPERTY(bool loading READ loading NOTIFY playbackStatusChanged)
    Q_PROPERTY(bool buffering READ buffering NOTIFY playbackStatusChanged)
    Q_PROPERTY(QString playbackError READ playbackError NOTIFY playbackStatusChanged)
