...
void Settings::loadBehaviorSettings()
{
    ...
    setBehaviorSubtitleAutoCopy(s.value(Keys::Behavior::SUBTITLE_AUTO_COPY,
        Keys::Behavior::SUBTITLE_AUTO_COPY_DEFAULT).toBool());
...
void Settings::writeBehaviorSettings()
{
    ...
    s.setValue(Keys::Behavior::SUBTITLE_AUTO_COPY, behaviorSubtitleAutoCopy());
    s.setValue(
        Keys::Behavior::SUBTITLE_PAUSE,
...
bool Settings::windowLibrary() const noexcept
{
    return m_window.library;
}

void Settings::setWindowLibrary(bool value)
{
    if (m_window.library == value)
    {
        return;
    }
    m_window.library = value;
    emit windowLibraryChanged(m_window.library);
}
...
bool Settings::behaviorSubtitleAutoCopy() const noexcept
{
    return m_behavior.subtitleAutoCopy;
}

void Settings::setBehaviorSubtitleAutoCopy(bool value)
{
    if (m_behavior.subtitleAutoCopy == value) return;
