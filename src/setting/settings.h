...
class Settings : public QObject
{
    ...
    Q_PROPERTY(
        bool windowLibrary
        READ windowLibrary
        WRITE setWindowLibrary
        NOTIFY windowLibraryChanged
    )
    ...
    Q_PROPERTY(bool behaviorSubtitleAutoCopy READ behaviorSubtitleAutoCopy
        WRITE setBehaviorSubtitleAutoCopy NOTIFY behaviorSubtitleAutoCopyChanged)
...
public:
    ...
    /**
     * @brief Gets whether the media library panel is open.
     */
    [[nodiscard]]
    bool windowLibrary() const noexcept;

    /**
     * @brief Sets whether the media library panel is open.
     */
    void setWindowLibrary(bool value);
    ...
    */
    ...
    bool behaviorSubtitleAutoCopy() const noexcept;
    void setBehaviorSubtitleAutoCopy(
        bool value = Keys::Behavior::SUBTITLE_AUTO_COPY_DEFAULT);
...
signals:
    ...
    /**
     * @brief Emitted when the media library panel state changes.
     */
    void windowLibraryChanged(bool value);
    ...
    void behaviorSubtitleAutoCopyChanged(bool value);
...
private:
    ...
    struct WindowSettings
    {
        ...
        /* true if the episode and torrent library was open on close */
        bool library{false};
    };
    ...
    struct BehaviorSettings
    {
        ...
        bool subtitleAutoCopy{Keys::Behavior::SUBTITLE_AUTO_COPY_DEFAULT};
