...
EpisodeFolder *Context::episodeLibrary() const noexcept
{
    return m_episodeLibrary;
}

JimakuClient *Context::jimakuClient() const noexcept
{
    return m_jimakuClient;
}

MigakuClient *Context::migakuClient() const noexcept
{
    return m_migakuClient;
}

TorrentSearchClient *Context::torrentsearchClient() const noexcept
{
    return m_torrentsearchClient;
}
...
{
    m_player = player;
    m_aniListClient->attachPlayer(player);
}
